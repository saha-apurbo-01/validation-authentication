                    ...
                    <table class="table table-bordered">
                        ...
                        <?php foreach ($select_res as $index => $ports) { ?>
                            <tr>
                                ...
                                <td><a href="port_delete.php?id=<?= $ports['Id'] ?>" title="Delete Portfolio"><i class="fa-solid fa-delete-left"></i></a></td>

                                <td><a href="port_edit.php?id=<?= $ports['Id'] ?>" title="Edit Portfolio"><i class="fa-regular fa-pen-to-square"></i></a></td>
